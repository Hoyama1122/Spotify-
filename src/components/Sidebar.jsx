...
const Sidebar = () => {
  return (
    <div className="text-white w-[25%] h-full gap-2 hidden flex-col  p-2 lg:flex">
      ...
      <div className="bg-[#121212] h-[85%] rounded">
        ...
        <div className="bg-[#242424] p-4 m-2 rounded font-semibold flex flex-col items-start justify-start gap-1 pl-4">
          ...
          <button className="py-1.5 px-4 bg-white text-[15px] text-black rounded-full hover:bg-[#b3b3b3] mt-4 ">
            Create Playlist
          </button>
        </div>
